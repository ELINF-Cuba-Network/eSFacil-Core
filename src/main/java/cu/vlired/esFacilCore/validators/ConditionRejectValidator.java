...
public class ConditionRejectValidator
    implements ConstraintValidator<ConditionReject, UUID> {
    ...
    @Override
    public void initialize(ConditionReject constraintAnnotation) {
    ...
    public boolean isValid(UUID id, ConstraintValidatorContext constraintValidatorContext) {
        ...
        return document.getCondition().equals(Condition.IN_REVIEWER);
    }
}
